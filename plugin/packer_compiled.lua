...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "neorg", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'DAPInstall.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-carbon-now-sh', 'vim-illuminate', 'vim-polyglot', 'nvim-ts-rainbow', 'vim-snippets', 'nvim-lspconfig', 'stabilize.nvim', 'symbols-outline.nvim', 'nvim-lsp-installer', 'fidget.nvim', 'telescope.nvim', 'friendly-snippets', 'gitsigns.nvim', 'hop.nvim', 'nvim-gps', 'cmp-nvim-lsp', 'mini.nvim', 'LuaSnip', 'null-ls.nvim', 'asynctasks.vim', 'lsp_signature.nvim', 'nvim-code-action-menu', 'AutoSave.nvim', 'goto-preview', 'nvim-colorizer.lua', 'neorg', 'toggleterm.nvim', 'Comment.nvim', 'trouble.nvim', 'nvim-treesitter', 'venn.nvim', 'asyncrun.vim', 'vim-snipmate'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'wilder.nvim', 'fzy-lua-native'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-carbon-now-sh', 'vim-illuminate', 'vim-polyglot', 'nvim-ts-rainbow', 'vim-snippets', 'nvim-lspconfig', 'stabilize.nvim', 'symbols-outline.nvim', 'nvim-lsp-installer', 'fidget.nvim', 'telescope.nvim', 'friendly-snippets', 'gitsigns.nvim', 'hop.nvim', 'nvim-gps', 'cmp-nvim-lsp', 'mini.nvim', 'LuaSnip', 'null-ls.nvim', 'asynctasks.vim', 'lsp_signature.nvim', 'nvim-code-action-menu', 'AutoSave.nvim', 'goto-preview', 'nvim-colorizer.lua', 'neorg', 'toggleterm.nvim', 'Comment.nvim', 'trouble.nvim', 'nvim-treesitter', 'venn.nvim', 'asyncrun.vim', 'vim-snipmate'}, { event = "BufRead *" }, _G.packer_plugins)]]
