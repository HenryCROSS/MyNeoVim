...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-nvim-lua", "vim-snippets", "cmp-nvim-lsp", "cmp_luasnip", "vim-snipmate" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'hop.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
