...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    config = { "\27LJ\2\nJ\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload\"core.plugin_config.dapinstall\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/DAPInstall.nvim",
  ...
  ["JABS.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/JABS.nvim",
  ...
  ["asyncrun.vim"] = {
    ...
    config = { "\27LJ\2\nH\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload core.plugin_config.asyncrun\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["bufdelete.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/bufdelete.nvim",
  ...
  ["cmp-nvim-lsp"] = {
    after = { "nvim-lsp-installer", "nvim-lspconfig" },
  ...
  ["cmp-under-comparator"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/cmp-under-comparator",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua" },
  ...
  ["nvim-dap"] = {
    ...
    config = { "\27LJ\2\nG\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload\31core.plugin_config.nvimdap\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-dap-ui"] = {
    config = { "\27LJ\2\nE\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload\29core.plugin_config.dapui\frequire\0" },
    load_after = {
      ["nvim-dap"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/nvim-dap-ui",
    url = "https://github.com/rcarriga/nvim-dap-ui"
  },
  ["nvim-dap-virtual-text"] = {
    config = { "\27LJ\2\nN\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload&core.plugin_config.dapvirtualtext\frequire\0" },
    load_after = {
      ["nvim-dap"] = true,
      ["nvim-treesitter"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/nvim-dap-virtual-text",
  ...
  ["nvim-lastplace"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henry/.local/share/nvim/site/pack/packer/opt/nvim-lastplace",
  ...
  ["nvim-tree.lua"] = {
    config = { "\27LJ\2\nH\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload core.plugin_config.nvimtree\frequire\0" },
    keys = { { "", "n" }, { "", "<Leader>op" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-autopairs", "neorg", "nvim-gps", "nvim-dap-virtual-text" },
  ...
  ["telescope.nvim"] = {
    ...
    commands = { "Telescope" },
    config = { "\27LJ\2\nI\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload!core.plugin_config.telescope\frequire\0" },
    keys = { { "n", "<Leader>bl" }, { "n", "<Leader>fo" }, { "n", "<Leader>ff" }, { "n", "<Leader>fg" }, { "n", "<Leader>fb" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
try_loadstring("\27LJ\2\n7\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tload\15core.theme\frequire\0", "config", "kanagawa.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-rainbow', 'cmp-under-comparator', 'stabilize.nvim', 'symbols-outline.nvim', 'fidget.nvim', 'gitsigns.nvim', 'goto-preview', 'hop.nvim', 'toggleterm.nvim', 'lsp_signature.nvim', 'neorg', 'venn.nvim', 'bufdelete.nvim', 'vim-carbon-now-sh', 'vim-illuminate', 'vim-polyglot', 'nvim-lsp-installer', 'Comment.nvim', 'cmp-nvim-lsp', 'telescope.nvim', 'trouble.nvim', 'mini.nvim', 'asynctasks.vim', 'asyncrun.vim', 'nvim-treesitter', 'JABS.nvim', 'AutoSave.nvim', 'nvim-code-action-menu', 'null-ls.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-ts-rainbow', 'cmp-under-comparator', 'stabilize.nvim', 'symbols-outline.nvim', 'fidget.nvim', 'gitsigns.nvim', 'goto-preview', 'hop.nvim', 'toggleterm.nvim', 'lsp_signature.nvim', 'neorg', 'venn.nvim', 'bufdelete.nvim', 'vim-carbon-now-sh', 'vim-illuminate', 'vim-polyglot', 'nvim-lsp-installer', 'Comment.nvim', 'nvim-colorizer.lua', 'cmp-nvim-lsp', 'telescope.nvim', 'trouble.nvim', 'mini.nvim', 'asynctasks.vim', 'asyncrun.vim', 'nvim-treesitter', 'JABS.nvim', 'AutoSave.nvim', 'nvim-code-action-menu', 'null-ls.nvim', 'nvim-lspconfig'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'nvim-lastplace', 'nvim-colorizer.lua', 'DAPInstall.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'wilder.nvim', 'fzy-lua-native'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
