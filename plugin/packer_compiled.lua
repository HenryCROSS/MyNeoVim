...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-snippets", "vim-snipmate", "cmp-buffer", "cmp_luasnip", "cmp-path", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lua" },
    load_after = {
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
