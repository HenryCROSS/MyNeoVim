...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-snippets", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "vim-snipmate" },
    load_after = {
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'hop.nvim', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
